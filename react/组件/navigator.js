	...
	导航器通过路由对象（route）来分辨不同场景。每个路由对象都对应一个页面组件，开发者设置什么，导航器显示什么，所以route是导航器中重要的一个组件
			...
			return(
				<Navigator
					/*
						...
						这个指定了，默认页面，也就是启动App之后会看到界面的第一屏
						这个对象的属性是自定义的，这个对象中的内容会在renderScene方法中处理
